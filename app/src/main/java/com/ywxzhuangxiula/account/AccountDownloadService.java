...
import com.ywxzhuangxiula.module.StringUtils;

public class AccountDownloadService extends Service {
            ...
            switch (msg.what) {
                ...
                case 1:
                    ...
                    if (rate < 100) {
                        ...
                        Intent intent = new Intent(mContext, AccountTotalActivity.class);
                        // 告知已完成
...
//							"文件已下载完毕", contentIntent);
    ...
    private void installApk() {
        ...
        AccountCommonUtil.installAPK(mContext, apkfile);
    }
